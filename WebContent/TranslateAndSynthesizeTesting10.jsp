...
<br/>
<br/>
<input type="button" value="Browse & Convert" onclick="window.location='TranslateAndSynthesizeTesting5.jsp'" >
<%
...
<br/>
<br/>
<label><b>Step3: Click to TextToSpeech - to convert text to audio</b></label>
<br/>
<br/>
...
TranslateAndSynthesizeTesting7.TextToSpeech("Fin",obj1frm10, obj3frm7);
